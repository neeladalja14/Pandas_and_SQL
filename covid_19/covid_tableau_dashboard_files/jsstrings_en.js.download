...
(function(w) {
  var s = {
    ...
    AnalyticsAssistantTryMePopoverBodyText: "Don\'t know where to start? Tableau Agent can help! Use generative AI to explore your data.",
    AnalyticsAssistantTryMePopoverTitle: "Tableau Agent popover title",
    ...
    CategoricalLegendHighlightOff: "Off",
    CategoricalLegendHighlightOn: "On",
    CategoricalLegendHighlighterButtonAriaLabel: "Highlight mode to select items in {0} is {1}.",
    CategoricalLegendListAriaLabel: "{0}. Press Enter to turn Highlight mode on or off. Use arrow keys to navigate the list of values. Then press Space to toggle the Highlight on or off for a value",
    CategoricalLegendTitle: "Legend for {0}",
    ...
    ConnectionDialogHeaderClose: "Close dialog",
    ...
    DataTabAddConnectionButtonAriaLabel: "Add connection",
    ...
    DataTabNewGeocodingEnhancementTableTooltipDisabledExtract: "Geocoding Enhancements not supported in extracts",
    ...
    DataTabTableSearchButtonAriaLabel: "Search list",
    ...
    DataTableNewGeocodingEnhancementTableLabel: "New Geocoding Enhancement",
    DataTableNewGeocodingEnhancementTableTooltip: "Add new gocoding enhancement",
    DatasourceHeaderDSSwitcherMenuAriaLabel: "Datasource switcher menu",
    ...
    ECTButtonTitle: "Get help with Tableau Agent",
    East: "east",
    ...
    InstantAnalyticsGenericExceptionMessage: "Your analysis couldn\'t load. Head back to your data platform {0} and try again.",
    ...
    LayoutPaneSpacingAllSidesEqualLocked: "All sides equal (on)",
    LayoutPaneSpacingAllSidesEqualUnlocked: "All sides equal (off)",
    LayoutPaneSpacingBottom: "Bottom",
    LayoutPaneSpacingLeft: "Left",
    LayoutPaneSpacingMarginButtonLabel: "Outer Padding: Left {0}, Top {1}, Right {2}, Bottom {3}",
    LayoutPaneSpacingPaddingButtonLabel: "Inner Padding: Left {0}, Top {1}, Right {2}, Bottom {3}",
    ...
    RuntimeAccessibilityAxisDescription: "{0} Axis, labeled from {1} to {2} with {3} tick labels.",
    RuntimeAccessibilityAxisDescriptionWithNoTickLabels: "{0} Axis with no tick labels.",
    RuntimeAccessibilityChildOfParentName: "{0} {1}",
    RuntimeAccessibilityElementNodeFocusWithMargin: "Press Space to toggle selection. Press Escape to go back to the {0} margin. Use arrow keys to navigate scene margin elements.",
    ...
    RuntimeAccessibilityHeaderFullTextAndFieldName: "{0}, {1} Header.",
    RuntimeAccessibilityHeaderNodeFocusWithMargin: "Press Space to toggle selection. Press Escape to go back to the {0} margin. Use arrow keys to navigate scene margin elements.",
    RuntimeAccessibilityHeaderNodeSelection: "Selected",
    RuntimeAccessibilityMovingAlongAxisWithRange: "Moving along the {0} axis with a data range from {1} to {2}.",
    RuntimeAccessibilityMovingDirectionAndCountOfMarks: "Moving {0}. Focus area contains {1} out of the {2} marks.",
    RuntimeAccessibilitySceneMarginScreenReaderText: "{0} margin. Press Enter to navigate inside the margin. Press Escape to go back to the {1}. Use arrow keys to navigate data visualization elements.",
